	...
	<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				...
				<option>BSIT Officers</option>
				<option>BSBA Officers</option>
				<option>BSOA Officers</option>
				<option>BSHM Officers</option>
	...
	$inserrt = "insert into users (username,password,firstname,lastname,user_type) values('$username','$password','$firstname','$lastname','$user_type')";
